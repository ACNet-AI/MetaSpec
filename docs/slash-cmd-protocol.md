...
This specification defines the **dual-layer architecture** for slash command systems in spec-driven toolkits generated by MetaSpec.
...
├── commands/              # Layer 1: AI Instructions
│   └── command.md.j2     # HOW to execute the command
└── templates/             # Layer 2: Output Formats
    └── output-template.md.j2  # WHAT format to generate
```
...
## 📋 Layer 1: Command Instruction Structure
...
## 📄 Layer 2: Output Template Structure
...
## 🎯 [Section 2: Requirements/Objectives]
[Define what needs to be achieved]

---

## 🏗️ [Section 3: Design/Approach]
...
## 📁 [Section 4: Structure/Organization]
...
All templates in the `templates/` directory follow the same specification - no distinction needed.
...
- [ ] Have clear section markers (`## 📋`, `## 🎯`, etc.)
...
## 🔗 How Commands and Templates Work Together
